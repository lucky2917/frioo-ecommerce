...
function initSentry(app) {
    ...
    Sentry.init({
        ...
        ignoreErrors: ['ECONNRESET', 'EPIPE', 'ENOENT', 'NetworkError'],
        beforeSend(event) {
            ...
            if (event.request?.data) {
                ['password', 'token', 'secret', 'creditCard'].forEach(field => {
...
const requestHandler = () => {
    ...
    return Sentry.Handlers.requestHandler({ ip: true, user: ['id', 'email'] });
};
