  ...
  return (
    <nav className="fr-catnav" aria-label="Product categories">
      ...
      <style>{`
        ...
        .fr-catnav-link { position: relative; flex-shrink: 0; font-family: var(--fr-font-sans); font-size: 0.9rem; font-weight: 500; color: var(--fr-text-2); text-decoration: none; padding: var(--fr-s1) 0; white-space: nowrap; transition: color var(--fr-dur-quick) var(--fr-ease-standard); }
