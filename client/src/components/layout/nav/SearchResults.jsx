  ...
  return (
    <div className="fr-results">
      ...
      <style>{`
        ...
        .fr-results-status { display: flex; align-items: center; gap: var(--fr-s2); padding: var(--fr-s3); font-size: 0.86rem; color: var(--fr-text-2); }
        ...
        .fr-result-name { font-size: 0.9rem; color: var(--fr-text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .fr-result-price { font-size: 0.86rem; font-weight: 700; color: var(--fr-text); font-variant-numeric: tabular-nums; }
