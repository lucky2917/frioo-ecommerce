...
const NAV_ITEMS = [
    ...
    },
    {
        group: 'Frioo Credits',
        links: [
            { to: '/admin/credits/dashboard', label: 'Credit overview', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
            { to: '/admin/credits/requests', label: 'Plan requests', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
            { to: '/admin/credits/plans', label: 'Credit plans', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
            { to: '/admin/credits/accounts', label: 'Customer accounts', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
            { to: '/admin/credits/transactions', label: 'Transactions', icon: 'M4 6h16M4 12h16M4 18h7' }
        ]
    }
];
