  ...
  return (
    <section className="fr-bundles" aria-label="Combos">
      ...
      <style>{`
        ...
        .fr-bundles-title { font-family: var(--fr-font-display); font-size: 1.5rem; font-weight: 700; color: var(--fr-text); margin: 0 0 var(--fr-s1); }
        .fr-bundles-sub { font-size: 0.92rem; color: var(--fr-text-2); margin: 0; }
        ...
        .fr-bundle-name { font-family: var(--fr-font-display); font-size: 1.1rem; font-weight: 650; color: var(--fr-text); margin: 0; }
        .fr-bundle-desc { font-size: 0.86rem; color: var(--fr-text-2); line-height: 1.5; margin: 0; }
        .fr-bundle-tags { display: flex; flex-wrap: wrap; gap: var(--fr-s2); margin-top: var(--fr-s1); }
        .fr-bundle-tag { font-size: 0.74rem; color: var(--fr-brand); background: var(--fr-brand-tint); padding: 3px 9px; border-radius: var(--fr-r-pill); }
        ...
        .fr-bundle-price { font-family: var(--fr-font-sans); font-size: 1.1rem; font-weight: 700; color: var(--fr-text); font-variant-numeric: tabular-nums; }
        .fr-bundle-add { height: 44px; padding: 0 var(--fr-s4); background: var(--fr-surface); border: 1px solid var(--fr-line-strong); color: var(--fr-text); border-radius: var(--fr-r-control); font-family: var(--fr-font-sans); font-size: 0.88rem; font-weight: 600; cursor: pointer; transition: border-color var(--fr-dur-quick) var(--fr-ease-standard), color var(--fr-dur-quick) var(--fr-ease-standard); }
